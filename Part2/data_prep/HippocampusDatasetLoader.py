...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # <YOUR CODE GOES HERE>
        # Ojo, aquí todo el mundo pone:
        # image = image.astype(np.single) / np.max(image)
        # pero yo creo que es más genérico así.
        ...
        # Reshape image padded with zeros and put contents in the upper left corner
        ...
        # ANSWER: Because labels are tags, not continuous numbers. This is what the network needs and also
        # it uses less memory.
